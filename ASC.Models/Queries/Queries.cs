...
namespace ASC.Models.Queries
{
    ...
    {
        public static string GetDashboardQuery(DateTime? requestedDateTime, List<string> status = null, 
            string customerEmail = "", string serviceEngineerEmail = "")
        {
            ...
            if (requestedDateTime.HasValue)
            {
                ...
                Constants.GreaterThanOrEqual, requestedDateTime.Value);
            }
            ...
            if (!string.IsNullOrWhiteSpace(customerEmail))
            {
                ...
                TableQuery.CombineFilters(finalQuery, TableOperators.And, TableQuery.GenerateFilterCondition("PartitionKey", Constants.Equal, customerEmail)) :
                TableQuery.GenerateFilterCondition("PartitionKey", Constants.Equal, customerEmail);
            }
